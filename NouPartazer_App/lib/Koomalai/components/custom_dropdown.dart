...
class _CustomDropdownScrollBehavior extends ScrollBehavior {
  const _CustomDropdownScrollBehavior();
    ...
    for (int itemIndex = 0; itemIndex < route.items.length; ++itemIndex) {
      ...
      children.add(FadeTransition(
        ...
        child: InkWell(
          ...
          onTap: () => Navigator.pop(
                context,
                _CustomDropdownRouteResult<T>(route.items[itemIndex].value),
              ),
        ),
      ));
    }
        ...
        child: Semantics(
          ...
          child: Material(
            ...
            child: ScrollConfiguration(
              behavior: const _CustomDropdownScrollBehavior(),
              child: Scrollbar(
                child: ListView(
...
class _CustomDropdownRouteResult<T> {
  ...
  bool operator ==(dynamic other) {
    if (other is! _CustomDropdownRouteResult<T>) return false;
    final _CustomDropdownRouteResult<T> typedOther = other;
...
class _CustomDropdownRoute<T>
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    Widget menu = _CustomDropdownMenu<T>(
      route: this,
...
class CustomDropdownButtonHideUnderline extends InheritedWidget {
  ...
  static bool at(BuildContext context) {
    return context
            .inheritFromWidgetOfExactType(CustomDropdownButtonHideUnderline) !=
        null;
  }
...
///
/// This sample shows a `CustomDropdownButton` whose value is one of
...
class CustomDropdownButton<T> extends StatefulWidget {
  ...
  /// The value of the currently selected [CustomDropdownMenuItem], or null if no
...
/// A convenience widget that wraps a [CustomDropdownButton] in a [FormField].
class CustomDropdownButtonFormField<T> extends FormField<T> {
  /// Creates a [CustomDropdownButton] widget wrapped in an [InputDecorator] and
  /// [FormField].
  ///
  /// The [CustomDropdownButton] [items] parameters must not be null.
