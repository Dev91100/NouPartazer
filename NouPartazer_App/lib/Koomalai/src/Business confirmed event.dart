...
import 'package:url_launcher/url_launcher.dart';
    ...
    class BusinessCompleted extends StatelessWidget {
                ...
                Container(
                  ...
                  alignment: Alignment.center,
                   child: RaisedButton.icon(
                     ...
                     icon: Icon(Icons.check_circle_outline,color: Colors.green,size: 30.0,),
                    label: Text("Completed",style: TextStyle(color: Colors.green, fontSize: 20.0),),
