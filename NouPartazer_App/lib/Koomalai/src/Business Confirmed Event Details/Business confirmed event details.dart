...
class BusinessConfirmedEvent extends StatelessWidget {
              ...
              children: <Widget>[
                Container(
                  ...
                  alignment: Alignment.topLeft,
                   child: RaisedButton.icon(
                    ...
                    label: Text("Confirmed",style: TextStyle(color: Colors.blue, fontSize: 20.0),),
                ...
                Container(
                  ...
                  child: RaisedButton.icon(
                    ...
                    label: Text("Cancelled",style: TextStyle(color: Colors.red, fontSize: 20.0),),
